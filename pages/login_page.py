...
class LoginPage(BasePage):
    ...
    def register_new_user(self, email, password):
        ...
        self.browser.find_element(*LoginPageLocators.REGISTER_FORM_PASSWD).send_keys(password)
        self.browser.find_element(*LoginPageLocators.REGISTER_FORM_PASSWD_REPEAT).send_keys(password)
